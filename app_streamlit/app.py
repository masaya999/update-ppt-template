...
from llm_assistant import completion_with_llm
...
df_assistant = pd.DataFrame()
updated_assistant_bool = False
...
def main():
    ...
    global updated_assistant_bool, df_assistant
